...
import { RustWipeVariable, ServerBackup, ServerEggVariable } from '@/api/server/types';
...
export const rawDataToRustWipeVariable = ({ attributes }: FractalResponseData): RustWipeVariable => ({
    id: attributes.id,
    name: attributes.option,
    value: attributes.value,
    isEggVariable: attributes.is_egg_variable,
    isForceOption: attributes.is_force_option,
});
